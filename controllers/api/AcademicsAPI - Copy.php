...
class AcademicsAPI extends REST_Controller {
	...
	function syllabusDetail_post(){
		$id = $this->post('syllabus_ID');
		$data['NAME']=$this->post('SYLLABUS_NAME');
		$data['DESC']=$this->post('SYLLABUS_DESC');
		$data['COURSE_ID']=$this->post('SYLLABUS_COURSE_ID');
		$data['SUBJECT_ID']=$this->post('SYLLABUS_SUBJECT_ID');
		$data['CRT_USER_ID']=$this->post('SYLLABUS_CRT_USER_ID');
		$data['UPD_USER_ID']=$this->post('SYLLABUS_UPD_USER_ID');
		if($id==NULL){
