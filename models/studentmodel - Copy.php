<?php
	...
	class studentmodel extends CI_Model {
	    ...
	    public function addStudentParentDetails($values){
			$data = array(
			   'STU_PA_ADM_NO' => $values['STU_PA_ADM_NO'],
			   ...
			   'STU_PA_USER_ID' => $values['STU_PA_USER_ID']
			);
			$this->db->insert('student_parent_details', $data); 
			$adm_id= $this->db->insert_id();
			if(!empty($adm_id)){
	    ...
	    public function addStudentPreviousEducation($values){
			$data = array(
			   'STU_PRE_D_ADM_NO' => $values['STU_PRE_D_ADM_NO'],
			   ...
			   'STU_PRE_D_CRT_DT' => $values['STU_PRE_D_CRT_DT'],
			   'STU_PRE_D_USER_ID' => $values['STU_PRE_D_USER_ID']
			);
			$this->db->insert('student_previous_education', $data); 
			$adm_id= $this->db->insert_id();
			if(!empty($adm_id)){
		...
		public function editStudentAdmissionDetails(){
			$data = array(
			    'STU_ADM_NO' => $values['STU_ADM_NO'],
			   'STU_ADM_DT' => $values['STU_ADM_DT'],
			   'STU_ADM_FIRST_NAME' => $values['STU_ADM_FIRST_NAME'],
	    ...
	    public function editStudentParentDetails(){
			$data = array(
	    ...
	    public function editStudentPreviousEducation(){
			$data = array(
			   ...
			   'STU_PRE_ADD_IMAGE_PATH' => $this->input->post('STU_PRE_ADD_IMAGE_PATH'),
