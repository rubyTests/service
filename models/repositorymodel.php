<?php
	...
	class repositorymodel extends CI_Model {
		...
		public function getAllRepositoryDetails(){
		...
		public function addRepositoryDetails($values){
			$data = array(
				'NAME' => $values['NAME'],
		...
		public function editRepositoryDetails($Id,$values){
			$data = array(
				'NAME' => $values['NAME'],
				'CATEGORY_ID' => $values['CATEGORY_ID'],
				'DEPT_ID' => $values['DEPT_ID'],
		...
		public function deleteRepositoryDetails($id){
